            ...
            <tbody>
                <?php foreach ($users as $user):?>
                    <tr>
                        ...
                        <td><a href=""><img src="/public/assets/icons/eye.ico" alt="Icono de visualizar no encontrado" class="icon"></a></td>
                        <td><a href=""><img src="/public/assets/icons/pencil.ico" alt="Icono de lapiz no encontrado" class="icon"></a></td>
                        <td><a href=""><img src="/public/assets/icons/trash.ico" alt="Icono de caneca no encontrado" class="icon trash"></a></td>
                    </tr>
                <?php endforeach?>
            </tbody>
        </table>
